                    ...
                    {settingOptions.map((option, index) => (
                        <div key={index} className={`${styles['option-wrap']}`}>
                            ...
                            {option.options.map((item, index) => (
                                <Row key={item.key} className={`${styles['option']}`}>
                                    <Col span={16}>
                                        <label style={{width: '150%'}} htmlFor={`option-${item.key}`}>
                                            {item.title}
                                        </label>
                                    </Col>
                                    <Col span={8}>
                                        {(item.key === "transitionTime" || item.key === "discardTime") ?
                                            <Input
                                                defaultValue={setting[item.key]}
                                                type="number"
                                            ...
                                            >
                                                {item.values.map((value, index) => (
                                                    <option key={index} value={value.values}>
                                                        {toTitleCase(value.label.toString())}
                                                    </option>
                                                ))}
                                            </select>
                                        }
