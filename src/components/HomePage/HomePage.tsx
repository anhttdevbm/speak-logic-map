...
const HomePage: React.FC = (): JSX.Element => {
    ...
    const [showPallet, setShowPallet] = useState<boolean>(true);
    ...
    }, [globalStore.map, globalStore.roomView, globalStore.floorPlanView, globalStore.boatView, globalStore.houseView,
        globalStore.rectangularView, globalStore.mapView, globalStore.tableView])
